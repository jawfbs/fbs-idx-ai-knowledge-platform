...
export const defaultSources: KnowledgeSource[] = [
  ...
  { id: "sales-drive", name: "Sales Guidance", type: "Google Drive", location: "Approved sales and pricing documents", priority: 3, enabled: true, health: "Healthy", lastIndexed: "Connected" },
  { id: "skill-registry", name: "Skill Registry", type: "GitHub", location: "jawfbs/fbs-idx-ai-knowledge-platform", priority: 4, enabled: true, health: "Healthy", lastIndexed: "Repository" },
  { id: "public-sites", name: "FBS Public Websites", type: "Website", location: "wearefbs.com, flexmls.com, sparkapi.io", priority: 5, enabled: true, health: "Warning", lastIndexed: "Planned" }
];
...
export const defaultRoutes: PromptRoute[] = [
  ...
  { id: "route-sales", name: "Sales Guidance", match: "pricing, product recommendation, sales, customer fit", skill: "Sales Guidance", connector: "Google Drive", priority: 3, enabled: true, fallback: false },
  { id: "route-skill", name: "Skill Registry", match: "skill, workflow, automation, prompt", skill: "Platform Skills", connector: "GitHub", priority: 4, enabled: true, fallback: false },
